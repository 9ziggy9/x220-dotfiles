...
;;   :config
;;   (custom-set-faces
;;    '(company-tooltip ((t (:inherit default :height 0.8))))
;;    '(company-tooltip-common ((t (:inherit font-lock-constant-face :height 0.8))))
;;    '(company-tooltip-selection ((t (:inherit font-lock-keyword-face :height 0.8))))
;;    '(company-tooltip-annotation ((t (:inherit font-lock-function-name-face :height 0.8))))))
;;   ;; (setq company-tooltip-limit 20)
;;   ;; (setq company-tooltip-maximum-width 10)
;;   ;; (setq company-tooltip-maximum-height 5)
;;   ;; (custom-set-faces
...
;; Integrating with other modes for a richer experience
;; (use-package company-web  ;; for web development
;;   :ensure t)
;; (use-package company-statistics  ;; sorts candidates based on previous usage
;;   :ensure t
;;   :config
...
;;   (setq company-quickhelp-delay 0.5)  ;; Adjust the delay as needed

;;   ;; Use pos-tip instead of popup, for better aesthetics
;;   (use-package pos-tip
;;     :ensure t
;;     :config
;;     (setq company-quickhelp-use-propertized-text t)
;;     (setq pos-tip-border-width 20)
